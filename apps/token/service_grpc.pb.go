...
func (c *serviceClient) IssueToken(ctx context.Context, in *IssueTokenRequest, opts ...grpc.CallOption) (*Token, error) {
	out := new(Token)
	err := c.cc.Invoke(ctx, "/kalandra.keyauth.token.Service/IssueToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) ValidateToken(ctx context.Context, in *ValidateTokenRequest, opts ...grpc.CallOption) (*Token, error) {
	out := new(Token)
	err := c.cc.Invoke(ctx, "/kalandra.keyauth.token.Service/ValidateToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) DescribeToken(ctx context.Context, in *DescribeTokenRequest, opts ...grpc.CallOption) (*Token, error) {
	out := new(Token)
	err := c.cc.Invoke(ctx, "/kalandra.keyauth.token.Service/DescribeToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) RevolkToken(ctx context.Context, in *RevolkTokenRequest, opts ...grpc.CallOption) (*Token, error) {
	out := new(Token)
	err := c.cc.Invoke(ctx, "/kalandra.keyauth.token.Service/RevolkToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) BlockToken(ctx context.Context, in *BlockTokenRequest, opts ...grpc.CallOption) (*Token, error) {
	out := new(Token)
	err := c.cc.Invoke(ctx, "/kalandra.keyauth.token.Service/BlockToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) ChangeNamespace(ctx context.Context, in *ChangeNamespaceRequest, opts ...grpc.CallOption) (*Token, error) {
	out := new(Token)
	err := c.cc.Invoke(ctx, "/kalandra.keyauth.token.Service/ChangeNamespace", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) QueryToken(ctx context.Context, in *QueryTokenRequest, opts ...grpc.CallOption) (*Set, error) {
	out := new(Set)
	err := c.cc.Invoke(ctx, "/kalandra.keyauth.token.Service/QueryToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) DeleteToken(ctx context.Context, in *DeleteTokenRequest, opts ...grpc.CallOption) (*DeleteTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kalandra.keyauth.token.Service/DeleteToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Service_IssueToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kalandra.keyauth.token.Service/IssueToken",
	}
...
func _Service_ValidateToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kalandra.keyauth.token.Service/ValidateToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Service_DescribeToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kalandra.keyauth.token.Service/DescribeToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Service_RevolkToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kalandra.keyauth.token.Service/RevolkToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Service_BlockToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kalandra.keyauth.token.Service/BlockToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Service_ChangeNamespace_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kalandra.keyauth.token.Service/ChangeNamespace",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Service_QueryToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kalandra.keyauth.token.Service/QueryToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Service_DeleteToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kalandra.keyauth.token.Service/DeleteToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Service_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "kalandra.keyauth.token.Service",
